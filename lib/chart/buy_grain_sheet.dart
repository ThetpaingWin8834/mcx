...
class BuyGrainSheet extends ConsumerStatefulWidget {
  static show(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => BuyGrainSheet(),
    );
  }

  const BuyGrainSheet({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _BuyGrainSheetState();
}

class _BuyGrainSheetState extends ConsumerState<BuyGrainSheet> {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              BuyButton(
                onPressed: () {
                  ref.read(homeNotifierProvider.notifier).state = 2;
